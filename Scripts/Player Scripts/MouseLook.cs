...
public class MouseLook : MonoBehaviour
{
    ...
    void LookAround()
    {
        ...
        //þetta bannar look_Angles.x að fara yfir -70f og 80f

        current_Roll_Angle =
            Mathf.Lerp(current_Roll_Angle, Input.GetAxisRaw(MouseAxis.MOUSE_X)
                        * roll_Angle, Time.deltaTime * roll_Speed);

        // fer frá A til B til C á þessum tima ramma Time.deltaTime * roll_Speed)
        //aka stoppar hvessu hátt uppí loftið ég get séð og hvessu mikið niður ég get séð
